...
<div class="container-fluid px-1 py-5 mx-auto">
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            <h3>New Offer</h3>
            <div class="card">
                <h5 class="text-center mb-4">Enter the car's informations</h5>
                <form class="form-card" method="POST" action="/save" enctype="multipart/form-data">
                    @csrf
                    <div class="row justify-content-between text-left">
                        {{-- make --}}
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Make<span class="text-danger"> *</span></label> <input type="text" id="make" name="car_make" placeholder="" > </div>
                        @error('name')
                        <span class="text-red-500 text-xs mt-1">{{$message}}</span>
                        @enderror
                        {{-- model --}}
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">model<span class="text-danger"> *</span></label> <input type="text" id="model" name="car_model" placeholder="" > </div>
                        @error('model')
                        <span class="text-red-500 text-xs mt-1">{{$message}}</span>
                        @enderror
                    </div>
                    <div class="row justify-content-between text-left">
                        {{-- year --}}
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">production year<span class="text-danger"> *</span></label> <input type="date" id="car_production_year" name="car_production_year" placeholder="" > </div>
                        @error('adress')
                        <span class="text-red-500 text-xs mt-1">{{$message}}</span>
                        @enderror
                        {{-- doors --}}
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Engine<span class="text-danger"> *</span></label>  
                            <select name="car_engine" id="car_engine" class=" w-4/6 py-1 px-3 rounded-full shadow-[0_0_5px] shadow-orange-400 bg-transparent focus:outline-none focus:ring focus:ring-orange-400">
                                <option value="0">choose the car's engine</option>
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Category<span class="text-danger"> *</span></label>  
                            <select name="car_category" id="car_category" class=" w-4/6 py-1 px-3 rounded-full shadow-[0_0_5px] shadow-orange-400 bg-transparent focus:outline-none focus:ring focus:ring-orange-400">
                                <option value="">choose the car's category</option>
                        ...
                        {{-- password --}}
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Price<span class="text-danger"> *</span></label> <input type="text" id="car_price" name="car_price" placeholder="" > </div>
                    </div>
                    <div class="row justify-content-between text-left">
                        {{-- role --}}
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Offer Type<span class="text-danger"> *</span></label>  
                            <select name="typeoffer_id" id="typeoffer_id" class=" w-4/6 py-1 px-3 rounded-full shadow-[0_0_5px] shadow-orange-400 bg-transparent focus:outline-none focus:ring focus:ring-orange-400">
                                <option value="">choose your offer type</option>
                        ...
                        {{-- password --}}
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Description<span class="text-danger"> *</span></label> <textarea type="textarea" id="description" name="description" placeholder="" ></textarea></div>
                    </div>
                    <div class="row justify-content-between text-left">
                        {{-- image --}}
