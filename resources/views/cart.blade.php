			...
			<div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							<li class="active" ><a href="/cart"><i class="fa fa-user"></i> My Pending offers</a></li>
							<li><a href="/UserConfirmed"><i class="fa fa-bolt"></i>My Confirmed offers (History) <span>23</span></a></li>
									...
									<div class="">
										<ul class="list-inline justify-content-center">
											<li class="list-inline-item">
												<a class="delete" href="{{url('/DeclineOfferCart?id='.$offer->offer_id)}}">
